...
# ╔═╡ e2a2dece-fb33-11ea-052d-c32cb73eef8e
using PlutoUI
...
function redify(c)
	return RGB(c.r, c.b, c.b)
end

# ╔═╡ 2744a556-e94f-11ea-2434-d53c24e59285
begin
	color = RGBX(0.9, 0.7, 0.0)
...
repeat(poor_phil, repeat_count, repeat_count+1)

# ╔═╡ b518b2a0-fb33-11ea-03f1-57fa0484b12b
decimate
...
@bind raw_camera_data camera_input(;max_size=20)
